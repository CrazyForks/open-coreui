...
- [x] 12.272 扩展运行配置，补 tasks 配置项
- [x] 12.273 实现 `backend/open_webui/routers/tasks.go` 的 `active/chats` 与 `config`
- [x] 12.274 在 `main.go` 接入 tasks 路由并加载 task config
- [x] 12.275 为 tasks 增加最小测试
- [x] 12.276 更新 `backend/SYNC_MAP.yaml` 中 tasks 路由状态
- [x] 12.277 再次运行 `go test ./open_webui/...`
- [x] 12.278 再次运行 `go test ./...`
- [x] 12.279 扩展 `backend/open_webui/routers/configs.go`，补 verify 类接口
- [x] 12.280 为 configs 增加 verify 类接口测试
- [x] 12.281 再次运行 `go test ./open_webui/...`
- [x] 12.282 再次运行 `go test ./...`
- [x] 12.283 扩展运行配置与 `ConfigsState`，补 models defaults 相关字段
- [x] 12.284 扩展 `backend/open_webui/routers/configs.go`，补 `models/defaults` 与 `models`
- [x] 12.285 在 `main.go` 加载 models defaults 配置到运行态
- [x] 12.286 为 configs 增加 models defaults 配置测试
- [x] 12.287 再次运行 `go test ./open_webui/...`
- [x] 12.288 再次运行 `go test ./...`
- [x] 12.289 扩展运行配置与 `ConfigsState`，补 suggestions 与 banners
- [x] 12.290 扩展 `backend/open_webui/routers/configs.go`，补 `suggestions` 与 `banners`
- [x] 12.291 在 `main.go` 加载 suggestions 与 banners 配置到运行态
- [x] 12.292 为 configs 增加 suggestions 与 banners 测试
- [x] 12.293 再次运行 `go test ./open_webui/...`
- [x] 12.294 再次运行 `go test ./...`
